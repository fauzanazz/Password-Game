const SetRules = [
    ...
    {
        description: "The digits in your password must add up to X"
    },
    {
    ...
    {
        description: "The Roman numerals in your password should multiply to X"
    },
    {
    ...
    {
        description: "🐔 Paul has hatched ! Please don’t forget to feed him. He eats X 🐛 every Y second"
    },
    {
        description: "Your password must contain one of the following words: I want IRK | I need IRK | I love IRK"
    },
    {
        description: "At least X% of your password must be in digits"
    },
    {
